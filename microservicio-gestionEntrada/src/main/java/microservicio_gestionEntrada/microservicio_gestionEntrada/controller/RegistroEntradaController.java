...
import com.microservicio.registroentrada.service.VehiculoEntradaService;
...
public class RegistroEntradaController {
    ...
    // Actualizar entrada
    @PutMapping("/{id}")
    public ResponseEntity<VehiculoEntrada> actualizar(@PathVariable Long id, @RequestBody VehiculoEntrada vehiculoActualizado) {
